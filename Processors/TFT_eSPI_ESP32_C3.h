...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  // Write 8 bits to TFT
  #define tft_Write_8(C)  GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char)(C)); WR_H

  #if defined (SSD1963_DRIVER)

    // Write 18-bit color to TFT
    #define tft_Write_16(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) (((C) & 0xF800)>> 8)); WR_H; \
                            GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) (((C) & 0x07E0)>> 3)); WR_H; \
                            GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) (((C) & 0x001F)<< 3)); WR_H
    ...
    #define tft_Write_16S(C) Cswap = ((C) >>8 | (C) << 8); tft_Write_16(Cswap)
      ...
      #define tft_Write_16(C)  GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H
      #define tft_Write_16S(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H
    #else
      // Write 16 bits to TFT
      #define tft_Write_16(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H; \
                              GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H

      // 16-bit write with swapped bytes
      #define tft_Write_16S(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H; \
                               GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H
    #endif

  #endif

  // Write 32 bits to TFT
  #define tft_Write_32(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 24)); WR_H; \
                          GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 16)); WR_H; \
                          GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >>  8)); WR_H; \
                          GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >>  0)); WR_H

  // Write two concatenated 16-bit values to TFT
  #define tft_Write_32C(C,D) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H; \
                             GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H; \
                             GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((D) >> 8)); WR_H; \
                             GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((D) >> 0)); WR_H

  // Write 16-bit value twice to TFT - used by drawPixel()
  #define tft_Write_32D(C) GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H; \
                           GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H; \
                           GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 8)); WR_H; \
                           GPIO.out_w1tc.val = GPIO_OUT_CLR_MASK; GPIO.out_w1ts.val = set_mask((unsigned char) ((C) >> 0)); WR_H
